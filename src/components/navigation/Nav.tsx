...
function Nav() {
  ...
  return (
    <nav className=" fixed  top-0 z-30 flex h-12  w-full flex-row justify-between   bg-base-200 px-6 shadow-slate-500/100 md:mx-0  md:h-16 md:px-12 ">
      <div className="flex h-full w-fit items-center justify-center text-sm capitalize">
        {" "}
        <button className="inline-flex items-center justify-center gap-2 rounded-md border border-transparent py-2 px-3 text-sm font-semibold text-base-content transition-all hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" onClick={() => router.push("/")}>
          {" "}
