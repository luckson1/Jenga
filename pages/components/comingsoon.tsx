...
const ComingSoonSVG = ({item, setItem}: {item?:string, setItem: Dispatch<SetStateAction<string | undefined>>}) => (
    <div className='my-16 h-screen w-screen bg-indigo-50'>
           <button className=" w-64 text-lg py-1.5 rounded-full hover:bg-violet-400 mt-5  font-light text-violet-700 outline outline-violet-700 hover:outline-none bg-violet-200 bg-opacity-70 hover:text-white" onClick={()=>setItem(undefined)}>
              Back
            </button>
